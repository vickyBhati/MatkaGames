...
public class AdapterAddSingleListTwp extends RecyclerView.Adapter<AdapterAddSingleListTwp.MyViewHolder>  {
    ...
    public AdapterAddSingleListTwp(Context applicationContext, OnItemClickListener onItemClickListener, ArrayList<Candy> myArrList) {
